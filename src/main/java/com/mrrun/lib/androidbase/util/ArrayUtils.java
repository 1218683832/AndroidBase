 ...
 * <b>1、增删移动相关</b> <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(1.01)、以无损的方式，
 * 将数组objects的元素从索引headIndex处开始到endIndex索引处结束的元素，向后移动number位：static void
 * backwardByLossless(Object[] objects, int headIndex, int endIndex, int number) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(1.02)、以无损的方式，
 * 将数组objects的元素从索引headIndex处开始到endIndex索引处结束的元素，向前移动number位：static void
 ...
 * static void insert(Object[] objects, int insertToIndex, Object element) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(1.06)、将数组objects中索引removeIndex出的元素删除：static Object
 * remove(Object[] objects, int removeIndex) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(1.07)、返回数组objects的字符串表示形式：static String
 * toString(Object[] objects) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(1.08)、在数组哦objects中搜索元素element：static int
 * search(Object[] objects, Object element) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(1.09)、将数组objects中索引setIndex出的元素用element替换：static
 * Object set(Object[] objects, Object element, int setIndex) <br>
 * <br>
 * <b>2、Int数组排序相关</b> <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(2.01)、使用选择排序法，对数组intArray进行排序：static void
 * SortingByChoose(int[] intArray, int type) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(2.02)、使用插入排序法，对数组intArray进行排序：static void
 * SortingByInsert(int[] intArray, int type) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(2.03)、使用冒泡排序法，对数组intArray进行排序：static void
 * SortingByBubbling(int[] intArray, int type) <br>
 * &nbsp;&nbsp;&nbsp;&nbsp;(2.04)、使用递归快排法，对数组intArray进行排序：static void
 * SortingByFastRecursion(int[] intArray, int start, int end, int type) <br>
...
public class ArrayUtils {
	...
	/**
	 * <b>方法功能描述:</b><br>
	 * 判断给定的数组对象是否为null或者是空的
	 * 
	 * @param objects
	 *            数组对象
	 * @return true:数组对象为null或者是空的
	 */
	...
	/**
	 * <b>方法功能描述:</b><br>
	 * 判断给定的数组对象集合中所有数组对象是否都为null或者是空的
	 * 
	 * @param objects
	 *            给定的数组对象集合
	 * @return true:所有数组对象都为null或者是空的
	 */
	public static boolean isEmpty(Object[]... objects) {
	...
	/**
	 * <b>方法功能描述:</b><br>
	 * 判断给定的数组对象是否不为null且不为空
	 * 
	 * @param objects
	 *            数组对象
	 * @return true:数组对象不为null且不为空
	 */
	...
	/**
	 * <b>方法功能描述:</b><br>
	 * 判断给定的数组对象集合中所有数组对象是否全部都不为null且不为空
	 * 
	 * @param objects
	 *            数组对象
	 * @return true:所有数组对象不为null且不为空
	 */
	public static boolean isNotEmpty(Object[]... objects) {
		for (Object[] o : objects) {
			if (isEmpty(o)) {
	 ...
	 *            排序的方式，用本类中的静态字段指定
	 */
	public static void sortByFastRecursion(int[] intArray, int start, int end,
			boolean ascending) {
	 ...
	 * @return 数组对象
	 */
	public static Object[] reverseArr(Object[] objects) {
	 ...
	 */
	public static String toString(int[] integers, String startSymbols,
			String separator, String endSymbols) {
	 ...
	 * @return 例如开始符号为"{"，分隔符为", "，结束符号为"}"，那么结果为：{1, 2, 3}
	 */
	public static String toString(Object[] objects, String startSymbols,
			String separator, String endSymbols) {
		boolean addSeparator = false;
		StringBuffer sb = new StringBuffer();
		// 如果开始符号不为null且不空
	 ...
	 * @param objects
	 *            数组对象
	 * @return 给定的数组为null或者是空的, return 0, 否则 return length
	 */
	 ...
	 * @param c
	 *            获得对象后要强转的类类型
	 * @return 如果数组对象为空或者数组越界返回null
	 */
	@SuppressWarnings("unchecked")
	public static <T> T getObjecByIndex(Object[] objects, int index, Class<T> c) {
