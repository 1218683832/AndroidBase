...
/**
 * Created by lipin on 2017/9/1.
 */

public class ScrollSpeedGridLayoutManger extends GridLayoutManager {

    private float MILLISECONDS_PER_INCH = 0.30f;
    private Context contxt;

    public ScrollSpeedGridLayoutManger(Context context, int spanCount) {
        ...
        LinearSmoothScroller linearSmoothScroller =
                new LinearSmoothScroller(recyclerView.getContext()) {
                    ...
                    public PointF computeScrollVectorForPosition(int targetPosition) {
                        return ScrollSpeedGridLayoutManger.this
