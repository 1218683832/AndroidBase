 ...
 * Tis is a SampleDrawer,define a Triangle.
 */

public class SampleDrawer extends Drawer {

    public SampleDrawer(int glDrawWay) {
        super(glDrawWay);
        init();
    }
    ...
    public void setupDrawOrder() {
        // mDrawOrder = new short[]{0, 1, 2, 0, 2, 3}; // 绘制的顺序
        // mDrawOrderBuffer = GLUtils.getShortBuffer(mDrawOrder);
    }
